...
class DeleteQuery(Query):
    ...
    compiler = 'SPARQLDeleteCompiler'

    def do_query(self, table, where, using):
        self.tables = [table]
        self.where = where
        self.get_compiler(using).execute_sparql(None)
...
class InsertQuery(Query):
    ...
    def insert_values(self, insert_values, raw_values=False):
        ...
        are inserted directly into the query, rather than passed as SPARQL
...
class AggregateQuery(Query):
    ...
    compiler = 'SPARQLAggregateCompiler'

    def add_subquery(self, query, using):
        self.subquery, self.sub_params = query.get_compiler(using).as_sparql(with_col_aliases=True)
